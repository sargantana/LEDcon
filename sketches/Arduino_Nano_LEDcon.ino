...
// predefined for ARDUINO NANO


   #include <EEPROM.h> 			//include EEPROM libary
 
    int LED_R = 3; 			//define pin for RED Channel 1
    int LED_G = 5; 				//define pin for GREEN Channel 1
    int LED_B = 6;  				//define pin for BLUE Channel 1
