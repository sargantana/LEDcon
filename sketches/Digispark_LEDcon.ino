...
// predefined for DIGISPARK / ATtiny85

   #include <SoftwareSerial.h> // include SoftwareSerial libary 
   #include <EEPROM.h> 			//include EEPROM libary
 

    int LED_R = 0; 			//define pin for RED Channel 1
    int LED_G = 1; 				//define pin for GREEN Channel 1
    int LED_B = 2;  				//define pin for BLUE Channel 1
    //int LED_R2 = 9; 			//define pin for RED Channel 2
    //int LED_G2 = 10; 				//define pin for GREEN Channel 2
    //int LED_B2 = 11; 				//define pin for BLUE Channel 2
    ...
    int blue;
    int accion=0;
    int bluetooth=3;			//define pin fpr digispark bluetooth Rx
    int port=0;
    int first_start;
    SoftwareSerial blueToothSerial(bluetooth);
